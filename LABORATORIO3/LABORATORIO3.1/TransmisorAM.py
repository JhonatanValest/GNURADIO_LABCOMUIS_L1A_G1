...
from CALCULODEPOTENCIAJ1C import CALCULODEPOTENCIAJ1C  # grc-generated hier_block
...
class TransmisorAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._A_win = RangeWidget(self._A_range, self.set_A, "Amplitud_Modulante", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.CALCULODEPOTENCIAJ1C_0 = CALCULODEPOTENCIAJ1C(
            I_vect=1024,
        )

        self.top_layout.addWidget(self.CALCULODEPOTENCIAJ1C_0)
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.CALCULODEPOTENCIAJ1C_0, 0))
