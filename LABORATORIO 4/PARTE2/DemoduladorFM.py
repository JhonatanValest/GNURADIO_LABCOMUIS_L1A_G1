...
class DemoduladorFM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fc_win = RangeWidget(self._fc_range, self.set_fc, "FrecuenciaPortadoro", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fc_win)
        self._Ga_range = Range(0, 3, 100e-3, 0.1, 200)
